...
namespace ApplicationVersionTracking.Controllers
{
    ...
    public class EventTypeController : Controller
    {
        ...
        public EventTypeController(ApplicationVersionTracking.Data.ApplicationContext context)
        {
            ...
            {
                _context.EventTypes.Add(new EventType { Description = "Default" });
        ...
        [HttpGet("{description}", Name = "GetEventType")]
        public IActionResult Get(string description)
        {
            var item = _context.EventTypes.FirstOrDefault(t => t.Description == description);
            if (item == null)
            {
                return NotFound();
            }
